  ...
  return (
    <>
      ...
      >
        ...
        >
          At <strong>Dream Aura Events</strong>, we don’t just film events — we craft cinematic stories.
          From slow-motion vows to aerial shots of grand entrances, our videography brings your moments
          to life with elegance and emotion.
        </p>
        ...
        <p style={{ fontSize: "16px", lineHeight: "1.8" }}>
          A video brings your event back to life — the laughter, the music, the tears, the vows.
          It's a time machine for your emotions. We make sure your film doesn’t just document the day
          but tells the story in a cinematic and heartfelt way.
        </p>
        ...
        <p style={{ fontSize: "16px", lineHeight: "1.8" }}>
          Our expert videographers combine creativity and technology to deliver stunning visuals and immersive sound.
          Whether it’s a romantic pre-wedding shoot or a high-energy reception reel,
          we frame your narrative with elegance and style.
        </p>
