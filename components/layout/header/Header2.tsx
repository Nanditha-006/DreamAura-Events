                            ...
                            <div className="col-lg-12">
                                <div className="menu-top-area">
                                    <div className="top-menu-area">
                                        <p>Contact us for your Dream Aura Event!</p>
                                        <ul>
                                            <li>
                                                <Link href="mailto:info@dreamauraevents.com">
                                                    <img src="/assets/img/icons/mail1.svg" alt="" />info@dreamauraevents.com <span> | </span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="tel:+917550277296">
                                                    <img src="/assets/img/icons/phn1.svg" alt="" />+91 75502 77296
                                                </Link>
                                            </li>
                                        </ul>
                                    </div>
