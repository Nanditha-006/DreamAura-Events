...
export default function Header8({ scroll, isMobileMenu, handleMobileMenu, isSearch, handleSearch }: any) {
    return (
        <>
            <header>
                            ...
                            <div className="col-lg-12">
                                <div className="menu-top-area">
                                    <div className="top-menu-area">
                                        <p>Ready to make your events unforgettable? <Link href="/pricing-plan">Get a Quote</Link></p>
                                        <ul>
                                            <li>
                                ...
                                <div className="header-elements">
                                                            ...
                                                            <div className="all-images-menu">
                                                                <div className="homemenu-thumb">
                                                                    ...
                                                                    <div className="homemenu-btn">
                                                                        <Link className="vl-btn8" href="/"><span className="demo">View Demo</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span></Link>
                                                                    </div>
                                    ...
                                    <div className="btn-area">
                                        ...
                                        <div className="btn-area1">
                                            <Link className="vl-btn8" href="/pricing-plan"><span className="demo">Get a Quote</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span></Link>
                                        </div>
                                    </div>
