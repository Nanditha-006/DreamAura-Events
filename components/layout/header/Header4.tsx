							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/"><img src="/assets/img/logo/logo3.png" alt="" /></Link>
									</div>
														...
														<div className="col-lg-12">
															<div className="all-images-menu">
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/"><span className="demo">View Demo</span></Link>
																	</div>
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index3"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index4"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb" style={{ margin: 0 }}>
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index5"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
															...
															<div className="all-images-menu">
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index6"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index7"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index8"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb">
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index9"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
																...
																<div className="homemenu-thumb" style={{ margin: 0 }}>
																	...
																	<div className="homemenu-btn">
																		<Link className="vl-btn4" href="/index10"><span className="demo">View Demo</span></Link>
																	</div>
																	<div className="homemenu-text">
